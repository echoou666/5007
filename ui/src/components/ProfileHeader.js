...
// Styles for modal content wrapper using styled-components
        ...
        <div className="profile-info">
          ...
          <div className="profile-stats">
            <span className="pointer" onClick={() => setFollowersModal(true)}>
              {followersState} subscirbed
            </span>

            <span className="pointer" onClick={() => setFollowingModal(true)}>
              {profile?.followingCount} subscriber
            </span>

            <span>{profile?.questionCount} questions</span>
